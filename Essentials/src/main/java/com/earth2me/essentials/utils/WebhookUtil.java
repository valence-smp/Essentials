...
public class WebhookUtil {
    ...
    public static class EmbedObject {
        ...
        private final static class Footer {
        ...
        private final static class Thumbnail {
            private final String url;
        ...
        private final static class Image {
            private final String url;
        ...
        private final static class Author {
            private String name;
            private String url;
